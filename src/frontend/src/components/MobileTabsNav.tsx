import { BookOpen, CircleDot, Home, Moon } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 sm:mt-6">
        ...
        <TabsContent value="namazogretici">
