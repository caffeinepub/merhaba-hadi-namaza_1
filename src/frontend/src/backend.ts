...
export class Backend implements backendInterface {
    ...
    async getAppSettings(arg0: Principal): Promise<AppSettings | null> {
        if (this.processError) {
            try {
    ...
    async getCallerAppSettings(): Promise<AppSettings | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerAppSettings();
                return from_candid_opt_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveCallerAppSettings(arg0: AppSettings): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveCallerAppSettings(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
