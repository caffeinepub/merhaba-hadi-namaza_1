...
export const tasbihatData: TasbihatItem[] = [
  ...
  },
  {
    ...
    transliteration:
      "Allâhu lâ ilâhe illâ hüvel-hayyül-kayyûm, lâ te'huzühû sinetün ve lâ nevm...",
    translation:
      "Allah, O'ndan başka ilah yoktur. O Hayy'dır, Kayyum'dur. O'nu ne uyuklama tutar ne de uyku...",
    count: 1,
  },
];
