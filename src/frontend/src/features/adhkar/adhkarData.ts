...
export const morningAdhkar: AdhkarItem[] = [
  ...
  },
  {
    ...
    translation:
      "De ki: O, Allah'tır, bir tektir. Allah Samed'dir. Doğurmamış ve doğmamıştır. Hiçbir şey O'na denk değildir.",
    count: 3,
  },
  {
    id: "morning-3",
  ...
  },
  {
    ...
    translation:
      "De ki: İnsanların Rabbine, insanların Malikine, insanların İlahına sığınırım.",
    count: 3,
  },
  {
    id: "morning-5",
...
export const eveningAdhkar: AdhkarItem[] = [
  ...
  },
  {
    ...
    arabic: "قُلْ هُوَ اللَّهُ أَحَدٌ اللَّهُ الصَّمَدُ لَمْ يَلِدْ وَلَمْ يُولَدْ وَلَمْ يَكُن لَّهُ كُفُوًا أَحَدٌ",
    translation:
      "De ki: O, Allah'tır, bir tektir. Allah Samed'dir. Doğurmamış ve doğmamıştır.",
    count: 3,
  },
  {
    id: "evening-3",
